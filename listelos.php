...
<div style="height: 30px;"></div>
     <h1 class="mt-4 mb-3">Listelos
        <small>y Cenefas</small>
      </h1>
      ...
      <li class="breadcrumb-item">
        ...
        <li class="breadcrumb-item active">Listelos y Cenefas</li>
...
<!--      <a style="color: gray">Disponemos de <?php echo $Total  ?> productos</a>-->
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a style='color:black' href='listelos.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a style='color:black' href='listelos.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a style='color:black' href='listelos.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";

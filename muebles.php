...
<!--      <a style="color: gray">Disponemos de <?php echo $Total  ?> productos</a>-->
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a style='color:black' href='muebles.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a style='color:black' href='muebles.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a style='color:black' href='muebles.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
